// Deterministic PRNG primitives - docs/05-MOCK-DATA-STRATEGY.md section 1.1, implemented
// verbatim. Math.random is banned inside src/data (ADR-005); every draw in the generator
// goes through createStream so a (family, key) pair always reproduces the same sequence.
